...
const MagicBento = ({
  ...
  customData = null, // Add support for custom data
  children,
}) => {
  ...
  // Use custom data if provided, otherwise use default cardData
  const dataToUse = customData || cardData;
              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-col gap-3 p-3">
                    ...
                    {card.title && (
                      <h3 className={`text-white text-[16px] font-semibold ${textAutoHide ? "text-clamp-1" : ""}`}>
                        {card.title}
                      </h3>
                    )}
                    {card.description && (
                      <p className={`text-[14px] text-white/70 leading-5 ${textAutoHide ? "text-clamp-2" : ""}`}>
                        {card.description}
                      </p>
                    )}
                  </div>
...
// Lightweight wrapper that provides MagicBento hover effects
// around arbitrary children content (e.g., Figma-styled card UI)
export const BentoCard = ({
  ...
  return (
    ...
    >
      {/* Minimal styles for border glow/text clamp if parent MagicBento isn't mounted */}
      <style>{`
        .card--border-glow::after {
          content: '';
          position: absolute;
