...
export const GenerateContentRequestSchema = Type.Object({
  ...
  bannerUrl: Type.Optional(
    Type.String({ format: "uri", description: "Banner image URL (Cloudinary)" })
  ),
  images: Type.Optional(
    Type.Array(Type.String({ format: "uri" }), {
      description: "Hosted image URLs",
    })
  ),
});
...
const EditorJsBlockSchema = Type.Object({
  ...
  data: Type.Any({
    description: "Block-specific data structure - flexible object",
  }),
});
...
export const GenerateContentResponseSchema = Type.Object({
  blogId: Type.String({
    format: "uuid",
    description: "Persisted blog identifier",
  }),
  generatedContent: Type.Object({
    ...
    bannerUrl: Type.Optional(
      Type.String({ format: "uri", description: "Banner image URL" })
    ),
...
>;
export type GenerateContentResponseDto = Static<
  typeof GenerateContentResponseSchema
>;
export type PatchGeneratedContentDto = Static<
  typeof PatchGeneratedContentSchema
>;
