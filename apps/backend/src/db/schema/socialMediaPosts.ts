import { pgTable, uuid, varchar, text, jsonb, timestamp, index, pgEnum, check } from 'drizzle-orm/pg-core'
import { sql } from 'drizzle-orm'
import { Type, Static } from '@sinclair/typebox'
import { rssFeedItems } from './rssFeedItems'

export const socialPlatform = pgEnum('social_platform', ['instagram', 'twitter'])
...
export const socialMediaPosts = pgTable('social_media_posts', {
  ...
  feedItemId: uuid('feed_item_id').references(() => rssFeedItems.id, { onDelete: 'set null' }),
...
export type InsertSocialMediaPostType = Static<typeof insertSocialMediaPostSchema>
export type SelectSocialMediaPostType = Static<typeof selectSocialMediaPostSchema>
