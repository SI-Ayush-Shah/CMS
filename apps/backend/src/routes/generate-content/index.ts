...
export type GenerateContentApiResponse = Static<
  typeof GenerateContentApiResponseSchema
>;
export type ErrorResponse = Static<typeof ErrorResponseSchema>;

// Re-export DTOs from service
export type { GenerateContentRequestDto, GenerateContentResponseDto };
...
const generateContentRoutes: FastifyPluginAsync = async (fastify) => {
  ...
  // Note: GET/PATCH moved under /content
};
